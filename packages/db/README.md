...
Run database commands from the repository root. The PostgreSQL sandbox connection and `DATABASE_URL` are documented in [local development](../../docs/development.md).
